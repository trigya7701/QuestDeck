...
$pass_error="";
    ...
    if(isset($_POST['Submit']))
    {
        ...
        {
            $name_error="Name Cannot Be Empty<br>";
        }
        else
        {
            $name_error="";
        ...
        {
            $phone_error="Entered Phone Number is Not Correct";
        }
        if(empty($_POST["password"]))
        {
            $pass_error="Password Cannot Be Empty";
        }
      if($name_error=="" && $email_error=="" && $phone_error=="" && $pass_error==""){
        setcookie("user_name",$_POST['fname'],time()+2*24*60*60);
        setcookie("user_email",$_POST['email'],time()+2*24*60*60);
        setcookie("user_phone",$_POST['phone'],time()+2*24*60*60);
        ...
        <div class="signup-form">
            ...
            <div class="form-left">
                ...
                <form method="POST" action="">
                                ...
                                <p class='name'><?php echo "$name_error";?></p>
                                <input type="email" name="email" placeholder=" Email">
                                <p class='name'><?php echo "$email_error";?></p>
                                <input type="text" name="phone" placeholder=" Phone">
                                <p class='name'><?php echo "$phone_error";?></p>
                ...
                <a href="login.php"> Aldready a user ? Sign in</a>
